<?php
function FTdeleteFbSessionData() {
...
function FTgetPageProfile($url, $postData = null, $username = null, $password = null) {
...
function FTgetPagePage($url, $postData = null, $username = null, $password = null) {
	global $fbStatusUpdatePath, $fbStatusCookieFile;
